...
static void     current_view_set_cursor               (GtkFileChooserDefault *impl,
                                                       GtkTreePath           *path);
static void     current_view_set_multiple             (GtkFileChooserDefault *impl,
		     ...
		     gboolean               property_notify)
{
  ...
  current_view_set_multiple (impl, select_multiple);
...
static void
current_view_set_multiple (GtkFileChooserDefault *impl, gboolean select_multiple)
{
  GtkTreeSelection *selection;
